...
CREATE TABLE loans(
    ...
    CONSTRAINT customer_loan--foreign key ile iki tablo arasında gerçek ve kontrol edilen bir bağlantı kurduk.
...
CREATE TABLE installments(
    ...
    CONSTRAINT fk_installments_loan--foreign key ile iki tablo arasında gerçek ve kontrol edilen bir bağlantı kurduk.virgülsüz
    FOREIGN KEY (loan_id)
    REFERENCES loans(id),
